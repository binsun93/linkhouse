                  ...
                  <table class="table table-striped b-t b-light">
                    ...
                    if (!empty($content)) {
                        ...
                        <tr id="<?php echo 'tr_' . $dTbl['module_id']; ?>">
                            ...
                            <td> 
                                <span id="itemEdit_<?php echo $row->cof_home_id; ?>">
                                     <label onclick="editInfo(<?php echo $row->sort_order; ?>,<?php echo $row->cof_home_id; ?>,'recommend')" style=" background-color:#E7EAEE ; padding:5px">
