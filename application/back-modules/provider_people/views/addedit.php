          ...
          <section class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div id="post_form" class="col-sm-8 left">
                    ...
                    <div class="form-group has-success">
                            <div class="col-sm-12" style="padding-left:0px">
                                <label class="col-sm-1 control-label" style="margin-bottom: 5px;  text-align: left;"><strong>Mô tả</strong></label>
                            </div> 
                            <div class="col-sm-12" >
                                <textarea rows="5" name="data_post[description]" id="summary_profle" class="form-control"><?php echo $detail[0]->description; ?></textarea>
                            </div>
                    </div>
                </div>
                        ...
                        <div class="panel-body">     
                            <div class="col-sm-12"> 
                                ...
                                <select name="data_post[type]" id="menus_parent_video" class="form-control">
                                    <?php $typeTextConfigHome = $this->main->getTypeTextProviderPeople(1); ?>
                                    ...
                                    <?php $typeTextConfigHome = $this->main->getTypeTextProviderPeople(2); ?>
                                    <option value="<?php echo $typeTextConfigHome; ?>" <?php if ($detail[0]->type == $typeTextConfigHome) { ?>selected<?php } ?>> <?php echo $typeTextConfigHome;; ?></option> 
                                </select>
