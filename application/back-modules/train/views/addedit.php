                        ...
                        <div class="panel-body">
                            ...
                            <div id="post_form" class="col-sm-8 left">
                                ...
                                <div class="form-group has-success">
                                    ...
                                    <div class="col-sm-12">
                                        <textarea rows="5" name="data_post[summary]" id="summary_profle" class="form-control">
                                            <?php echo $detail[0]->summary; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-group has-success">
                                    <div class="col-sm-12" style="padding-left:0px">
                                        <label class="col-sm-1 control-label" style="margin-bottom: 5px;  text-align: left;"><strong>Description</strong>
                                        </label>
                                    </div>
                                    <div class="col-sm-12">
