...
class My_ajax_pagination {
    ...
    var $full_tag_open        = '';
    var $full_tag_close        = '';
    var $first_tag_open        = '<div class="first button">';
    var $first_tag_close    = '</div>';
    var $last_tag_open        = '<div class=" last button">';
    var $last_tag_close        = '</div>';
    var $cur_tag_open        = '<li><a class="active">';
    var $cur_tag_close        = '</a></li>';
    var $next_tag_open        = '<div class="next button">';
    var $next_tag_close        = '</div>';
    var $prev_tag_open        = '<div class="prev button">';
     ...
     */
    function My_ajax_pagination($params = array())
    {
        if (count($params) > 0)
        {
...
//        }
        ...
        if  ($this->cur_page != 1)
        {
            ...
            $link = $this->my_link_to_remote($this->base_url.$i , $this->prev_link, $this->div, $pars);
        ...
        for ($loop = $start -1; $loop <= $end; $loop++)
        {
            ...
            if ($i >= 0)
            {
                ...
                else
                {
                    ...
                    $link = $this->my_link_to_remote($this->base_url.$loop, $loop, $this->div, $pars);
        ...
        if ($this->cur_page < $num_pages)
        {
            ...
            $i=$this->cur_page+1;
            $link = $this->my_link_to_remote($this->base_url.$i, $this->next_link, $this->div, $pars);
        ...
        if (($this->cur_page + $this->num_links) < $num_pages)
        {
            ...
            $pars = array($this->postVar=>$i);
            $link = $this->my_link_to_remote($this->base_url.$num_pages, $this->last_link, $this->div, $pars);
    ...
    function my_link_to_remote($url, $text, $div, $pars=array()){
        ...
        $par="{".$par."}";
        $html = "<a href='' onclick=\"ajax_get('$url',{$par},'{$this->return_id}');return false;\">$text</a>";
