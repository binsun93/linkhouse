...
class Emailer implements interfaceEmail
{
	...
	public function __construct()
	{
		...
		$opts = array( 
		        ...
		        'charset'  	=> 'utf-8',
		        'method' 	=> 'smtp',
		        'smtp_host' =>"ssl://smtp.gmail.com",//  VSFactory::getSettings()->getSystemKey("smtp_host","websiteviet.com","configs"),
		        'smtp_port' => 465,
				'smtp_user' =>"thienduongkhoedep@gmail.com",// VSFactory::getSettings()->getSystemKey("smtp_user","customer@vstatic.net","configs"),
				'smtp_pass' => "thienduongkd123",//VSFactory::getSettings()->getSystemKey("smtp_password","@customer#*#%@","configs"),
		        'smtp_helo' => 'EHLO',
		        'wrap_brackets' => false);
		*/
